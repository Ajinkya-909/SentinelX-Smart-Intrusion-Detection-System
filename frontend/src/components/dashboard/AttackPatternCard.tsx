  ...
  return (
    <div className="flex flex-col h-full bg-[#121212] border border-gray-800 rounded-xl p-6 shadow-lg relative overflow-hidden">
      <div className="flex items-center space-x-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-100">Attack Pattern: {data.pattern_type}</h3>
          <p className="text-sm text-gray-400">Sequence and objective analysis</p>
        </div>
      </div>
